...
| **5 — Daily selector + execution prep** | Selector consumes Phase 4.1 readiness flags to pick the day's signal; execution paths still gated behind manual confirm. | ⏳ |
